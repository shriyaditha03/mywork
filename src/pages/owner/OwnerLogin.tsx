...
const OwnerLogin = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await loginWithUsername(username, password, 'owner');
        ...
        <div className="min-h-screen ocean-gradient flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-card rounded-2xl p-6 sm:p-8 shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-muted-foreground text-sm">Access your Hatchery Dashboard</p>
                </div>
                ...
                <div className="text-center mt-6 space-y-2 border-t pt-4">
                    ...
                    <div className="flex justify-center gap-4 text-xs text-muted-foreground">
                        <Link to="/user/login" className="hover:text-primary">Staff Portal</Link>
